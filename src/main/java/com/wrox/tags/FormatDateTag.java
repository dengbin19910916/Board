...
public class FormatDateTag extends TagSupport {
    private static final long serialVersionUID = -5821759851526232451L;
    ...
    static {
        try {
            GET_LOCALE_METHOD = SetLocaleSupport.class.getDeclaredMethod("getFormattingLocale",
