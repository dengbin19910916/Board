...
public class FromHowTo {
    public void processOneSheet(String filename) throws Exception {
        ...
        SharedStringsTable sst = r.getSharedStringsTable(); // SharedStringsTable => /xl/sharedStrings.xml
        StylesTable st = r.getStylesTable();    // StylesTable => /xl/styles.xml
...
//        howto.processAllSheets(Test.clerk);
    }
}
